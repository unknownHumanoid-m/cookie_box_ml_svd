# -*- coding: utf-8 -*-
"""
Evaluate the "how many pulses" MLP on 2D processed / SVD / denoised h5 files.
...
are pulled from the file.

Example
-------
    python3 evaluate_how_many.py \
        --data_dirs /path/to/mrco_h5_svd/2d_svd_test/ \
        --model_path /path/to/how_many_svd2d_r8.pth
"""
