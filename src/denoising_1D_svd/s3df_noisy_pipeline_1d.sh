...
#SBATCH --job-name=noisy_pipeline_1d
...
# ============================================================================
# Noisy 1D-SVD baseline: train + eval how_many_1d, phase_single_1d,
# phase_two_1d on the raw noisy Ximg from mrco_h5_svd/1d_svd_r8_{train,test}.
# No 1D denoiser exists yet, so this run skips the denoise stage entirely and
# just uses input_key=Ximg. Identifiers include '_noisy_svd1d_r8' so figures
# and checkpoints don't collide with the denoised-2D runs.
# ============================================================================
...
export EVAL_DATA_DIRS="/sdf/home/m/miaed/tmo_exp/tmo101347625/scratch/miaed_mnis_data/mrco_h5_svd/1d_svd_r8_test"
export INPUT_KEY="Ximg"

# ---- how_many_1d classifier ------------------------------------------------
...
export HM_SAVE_DIR="/sdf/home/m/miaed/tmo_exp/tmo101347625/scratch/denoising_runs/how_many_noisy_svd1d_r8/"
export HM_IDENTIFIER="how_many_noisy_svd1d_r8"
export HM_MODEL_PATH="${HM_SAVE_DIR}/${HM_IDENTIFIER}.pth"
export HM_EVAL_IDENTIFIER="${HM_IDENTIFIER}_eval"

# ---- phase_single_1d regressor ---------------------------------------------
...
export PS_SAVE_DIR="/sdf/home/m/miaed/tmo_exp/tmo101347625/scratch/denoising_runs/phase_single_noisy_svd1d_r8/"
export PS_IDENTIFIER="phase_single_noisy_svd1d_r8"
...
export PT_SAVE_DIR="/sdf/home/m/miaed/tmo_exp/tmo101347625/scratch/denoising_runs/phase_two_noisy_svd1d_r8/"
export PT_IDENTIFIER="phase_two_noisy_svd1d_r8"
...
REGRESSION_1D_DIR=/sdf/home/m/miaed/jack_cookiebox_copy/COOKIE_ML/src/ml_backbone/regressions_1D_SVD
...
# ---------------------------------------------------------------------------
# 1) Train how_many_1d on noisy Ximg
# ---------------------------------------------------------------------------
echo "===== [1/6] train_how_many.py (1D, input_key=${INPUT_KEY}) ====="
cd "${DENOISING_1D_DIR}"
...
# ---------------------------------------------------------------------------
# 2) Evaluate how_many_1d
# ---------------------------------------------------------------------------
echo "===== [2/6] evaluate_how_many.py (1D) ====="
...
# ---------------------------------------------------------------------------
# 3) Train phase_single_1d on noisy Ximg
# ---------------------------------------------------------------------------
echo "===== [3/6] train_phase_single.py (1D, input_key=${INPUT_KEY}) ====="
cd "${REGRESSION_1D_DIR}"
...
# ---------------------------------------------------------------------------
# 4) Evaluate phase_single_1d (gated by how_many_1d)
# ---------------------------------------------------------------------------
echo "===== [4/6] eval_phase_single.py (1D) ====="
...
# ---------------------------------------------------------------------------
# 5) Train phase_two_1d on noisy Ximg
# ---------------------------------------------------------------------------
echo "===== [5/6] train_phase_two.py (1D, input_key=${INPUT_KEY}) ====="
...
# ---------------------------------------------------------------------------
# 6) Evaluate phase_two_1d (gated by how_many_1d)
# ---------------------------------------------------------------------------
echo "===== [6/6] eval_phase_two.py (1D) ====="
