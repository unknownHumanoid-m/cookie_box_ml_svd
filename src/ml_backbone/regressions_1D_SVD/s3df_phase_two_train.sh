...
# The values below are passed to train_phase_two.py as CLI flags.
# ----------------------------------------------------------------------------
...
# Deep-MLP output bins over the [0, pi] wrapped-diff range.
...
export MODEL_SAVE_DIR="/sdf/home/m/miaed/tmo_exp/tmo101347625/scratch/denoising_runs/phase_two_svd1d_r8/"
export MODEL_IDENTIFIER="phase_two_svd1d_r8"
...
CMD=(python3 train_phase_two.py
