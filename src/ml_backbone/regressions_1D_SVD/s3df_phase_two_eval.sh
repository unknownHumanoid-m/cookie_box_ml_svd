...
#SBATCH --job-name=phase_two_eval_1d
...
# ----------------------------------------------------------------------------
# Eval-only: runs the already-trained 1D-SVD two-pulse regressor twice —
...
# Denoised branch.
export DENOISED_MODEL_PATH="/sdf/home/m/miaed/tmo_exp/tmo101347625/scratch/denoising_runs/phase_two_svd1d_r8/phase_two_svd1d_r8.pth"
...
export DENOISED_EVAL_IDENTIFIER="phase_two_svd1d_r8_eval_denoised"

# Noisy branch.
export NOISY_MODEL_PATH="/sdf/home/m/miaed/tmo_exp/tmo101347625/scratch/denoising_runs/phase_two_noisy_svd1d_r8/phase_two_noisy_svd1d_r8.pth"
...
export NOISY_EVAL_IDENTIFIER="phase_two_svd1d_r8_eval_noisy"
...
run_eval () {
    ...
    local cmd=(python3 eval_phase_two.py
