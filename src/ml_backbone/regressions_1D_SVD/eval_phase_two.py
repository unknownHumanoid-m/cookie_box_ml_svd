# -*- coding: utf-8 -*-
"""
Evaluate the deep-MLP two-pulse phase-diff regressor on autoencoder-denoised
...
-------
    python3 eval_phase_two.py \
        ...
        --model_path /path/to/phase_two_mlp.pth \
...
class PhaseMLP(nn.Module):
    """Mirrors train_phase_two.PhaseMLP."""
...
def main():
    ...
    model.eval()
    print(f"phase-two regressor loaded: num_classes={num_classes}, "
    ...
    with torch.no_grad():
        for imgs, diffs_true, npulses in loader:
            ...
            hm_logits = hm_model(imgs)  # imgs already (N, L)
