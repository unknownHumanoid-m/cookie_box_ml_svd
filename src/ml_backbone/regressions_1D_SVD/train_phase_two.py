# -*- coding: utf-8 -*-
"""
Train the deep-MLP two-pulse phase-difference regressor on
autoencoder-denoised 1D-SVD h5 files.
...
See train_phase_single.py in this folder for why the backbone is a deep MLP
(`PhaseMLP`) rather than the 2D-SVD sibling's ResNet18.
...
class PhaseMLP(nn.Module):
    ...
    those logits via softmax-weighted mean (see logits_to_diff).
    """
